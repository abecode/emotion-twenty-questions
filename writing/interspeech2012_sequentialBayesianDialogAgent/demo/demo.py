...
def nlpClassifyYN(str):
    ...
    elif re.search(r'\byeah\b',str)  : ans = 1
    elif re.search(r'\byea\b',str)  : ans = 1
    elif re.search(r'\byep\b',str)  : ans = 1
    elif re.search(r'\baye\b',str)  : ans = 1
    elif re.search(r'\bsure\b',str)  : ans = 1
    elif re.search(r'\bno\b',str)  : ans = -1
    elif re.search(r'\bnope\b',str)  : ans = -1
...
class SemanticKnowledge(NaiveBayesClassifier):
   ...
   def setPriors(self,label_probdist):
      if not isinstance(label_probdist,ProbDistI):
         try:
            label_probdist = MLEProbDist(label_probdist)
         except:
            pass
